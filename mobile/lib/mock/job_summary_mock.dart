...
// Local copy of the backend mock dataset — used as a fallback if the API is unreachable.

import '../models/job_summary.dart';

const List<Map<String, dynamic>> _kRaw = [
  {
    'job_id': 'job-001',
...
final List<JobSummary> kJobSummaryMock =
    _kRaw.map(JobSummary.fromJson).toList();
